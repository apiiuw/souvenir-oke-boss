...
<aside id="sidebar" class="fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-200 z-50 transition-transform duration-300 lg:translate-x-0 -translate-x-full">
    ...
    <nav class="mt-6 flex flex-col gap-1 px-4">
        ...
        <a href="{{ route('admin.customers.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all {{ Request::is('admin/customers*') ? 'sidebar-item-active' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900' }}">
            ...
            <span class="font-semibold text-sm">Data Pelanggan</span>
        </a>
