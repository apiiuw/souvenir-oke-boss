      ...
      <div class="flex items-center space-x-4">
        @auth
          @if(!auth()->user()->isAdmin())
            @include('partials.user.profile-links', ['desktop' => true])
            <a href="{{ route('user.orders.index') }}" class="hidden md:inline-flex items-center rounded-2xl border border-pink-200 px-4 py-2 text-sm font-semibold text-pink-600 transition hover:bg-pink-50">
              Pesanan Saya
            </a>
            <form action="{{ route('logout') }}" method="POST" class="hidden md:block">
              @csrf
              <button type="submit" class="rounded-2xl border border-gray-200 px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-50">
                Logout
              </button>
            </form>
          @else
            <div class="hidden md:flex items-center gap-3">
              <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center rounded-2xl border border-gray-200 px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-50">
                Dashboard Admin
              </a>
        ...
        @else
          <div class="hidden md:flex items-center gap-3">
            <a href="{{ route('login') }}" class="inline-flex items-center rounded-2xl border border-gray-200 px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-50">
              Login User
            </a>
            <a href="{{ route('register') }}" class="inline-flex items-center rounded-2xl bg-pink-oke-boss px-4 py-2 text-sm font-semibold text-white transition hover:bg-pink-600">
              Daftar
            </a>
          </div>
        @endauth
        ...
        <a href="https://wa.me/6285780007175?text=Halo%20Admin%20Souvenir%20Oke%20Boss%2C%20saya%20ingin%20bertanya%20seputar%20produk." target="_blank" class="hidden md:flex items-center space-x-3 px-4 py-2 bg-green-500 text-white rounded-2xl hover:bg-green-600 transition">
  ...
  <!-- Mobile Menu (Collapsible) -->
    ...
    <div class="bg-gray-50 border-t border-gray-200">
        ...
        <li class="pt-2 border-t border-gray-200">
            <a href="https://wa.me/6285780007175?text=Halo%20Admin%20Souvenir%20Oke%20Boss%2C%20saya%20ingin%20bertanya%20seputar%20produk." target="_blank"
        ...
        @auth
            <li>
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="w-full rounded-lg bg-gray-900 px-3 py-2 text-left text-sm font-semibold text-white hover:bg-gray-800 transition">
                        Logout
                    </button>
                </form>
            </li>
